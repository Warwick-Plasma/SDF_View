...
def _arithmetic(base,secondarray,function,symbol,**kwargs):
    ...
    try:
        ...
        l=lambda caller, backingdata, a2=secondarray.data: function(caller,backingdata,a2)
    except:
        l=lambda caller, backingdata, a2=secondarray: function(caller,backingdata,a2)
...
def average(base,direction=0,**kwargs):
    ...
    #Finally create the actual derived variable and return it
    dv=derived_variable(name=name,datafunction=l,backingdata=base,grid=ngrid,
        grid_mid=ngrid_mid,dims=dims,**kwargs)
    return dv
...
def abs_sq(base,**kwargs):
    ...
    kwargs['name']=name
    dv=derived_variable(name=name,datafunction=_abs_sq,backingdata=base,grid=base.grid,
        grid_mid=base.grid_mid,dims=base.dims,**kwargs)
    return dv
...
def subarray(base,slices,name=None):
    ...
    l=lambda caller, backingdata, a2=subscripts: _slice(caller,backingdata,a2)
    #Finally create the actual derived variable and return it
